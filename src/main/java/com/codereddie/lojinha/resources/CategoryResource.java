...
public class CategoryResource {
	...
	public ResponseEntity<?> findAll() {
		...
		List<CategoryDTO> dtoList = categories.stream().map(category -> new CategoryDTO(category))
	 ...
	 * @author Edcleidson Júnior
	 * @param Integer - ID
	 * @return Objeto categoria não DTO - Retorna um objeto categoria normal com
	 *         suas listas e dependentes
	 */
	 ...
	 * @author Edcleidson Júnior
	 * 
	 * @return Uma página com os dados buscados, apenas dados no padrão DTO
	 *         implementado Não traz produtos e dependentes
	 */
